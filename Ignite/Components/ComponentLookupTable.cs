...
namespace Ignite.Components
{
    ...
    {
        private readonly ImmutableDictionary<Type, ulong> _componentsIndex =
        ...
        public ulong this[Type type] => GetIndex(type);
        ...
        public ulong this[IComponent component] => GetIndex(component.GetType());
        ...
        /// <returns>Index of the component</returns>
        public ulong GetIndex<T>() where T : class, IComponent
            => GetIndex(typeof(T));
        ...
        /// <param name="type"><see cref="Type"/> of the component we want the index of</param>
        /// <returns>Index of the component</returns>
        public ulong GetIndex(Type type)
        {
        ...
        /// <returns>Index of the component</returns>
        public ulong GetOrCreateIndex<T>() where T : class, IComponent
        ...
        /// <returns>Index of the component</returns>
        public ulong GetOrCreateIndex(Type type)
        {
            Debug.Assert(typeof(IComponent).IsAssignableFrom(type),
                $"Why are we trying to get a component index for a not component type ?");
            ...
            index = Convert.ToUInt64(_componentsIndex.Count);
